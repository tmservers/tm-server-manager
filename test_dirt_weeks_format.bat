...
spacetime call tm-server-manager create_project "Dirt Weeks 26'" "The Dirt Weeks are nice." "{""Tournament"": {}}" "{""__timestamp_micros_since_unix_epoch__"": 1767132984000000 }" "{""__timestamp_micros_since_unix_epoch__"": 1767233084000000 }"
