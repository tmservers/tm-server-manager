...
const tablesSchema = __schema(
  ...
  __table({
    ...
    constraints: [
      { name: 'tab_raw_server_method_call_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TabRawServerMethodCallRow),
  __table({
    name: 'tab_raw_server_method_call_resolved',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
    ...
    constraints: [
      { name: 'tab_raw_server_method_call_resolved_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TabRawServerMethodCallResolvedRow),
  __table({
    name: 'tab_raw_server_method_response',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
