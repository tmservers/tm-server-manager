...
import CompetitionConnectionData from "./competition_connection_data_type";
...
const tablesSchema = __schema(
  ...
  __table({
    ...
    constraints: [
      { name: 'tab_competition_connection_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TabCompetitionConnectionRow),
  __table({
    name: 'tab_competition_connection_data',
    indexes: [
      { name: 'competition_id', algorithm: 'btree', columns: [
        'competitionId',
      ] },
  ...
  __table({
    name: 'tab_tournament',
    indexes: [
      { name: 'creator_account_id', algorithm: 'btree', columns: [
        'creatorAccountId',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
        'id',
