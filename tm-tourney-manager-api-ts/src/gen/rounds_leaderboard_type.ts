...
import { RoundsRound } from "./rounds_round_type";
// Mark import as potentially unused
declare type __keep_RoundsRound = RoundsRound;
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    ...
    _cached_RoundsLeaderboard_type_value.value.elements.push(
      ...
      { name: "currentRound", algebraicType: __AlgebraicTypeValue.U16 },
      { name: "round", algebraicType: __AlgebraicTypeValue.Array(RoundsRound.getTypeScriptAlgebraicType()) },
    );
