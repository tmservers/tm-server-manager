...
import { ServerMethodResponse } from "./server_method_response_reducer.ts";
...
import { TmServerMethodResponseTableHandle } from "./tm_server_method_response_table.ts";
export { TmServerMethodResponseTableHandle };
...
export { MethodCall };
import { MethodError } from "./method_error_type.ts";
export { MethodError };
import { MethodResponse } from "./method_response_type.ts";
...
import { TmServerMethodResponse } from "./tm_server_method_response_type.ts";
...
const REMOTE_MODULE = {
  tables: {
    ...
    tm_server_method_response: {
      tableName: "tm_server_method_response" as const,
      rowType: TmServerMethodResponse.getTypeScriptAlgebraicType(),
      primaryKey: "id",
      primaryKeyInfo: {
        colName: "id",
        colType: (TmServerMethodResponse.getTypeScriptAlgebraicType() as __AlgebraicTypeVariants.Product).value.elements[0].algebraicType,
      },
    },
    tournament: {
  ...
  reducers: {
    ...
    server_method_response: {
      reducerName: "server_method_response",
      argsType: ServerMethodResponse.getTypeScriptAlgebraicType(),
    },
    set_tm_server_state: {
...
export class SetReducerFlags {
  ...
  serverMethodResponseFlags: __CallReducerFlags = 'FullUpdate';
  serverMethodResponse(flags: __CallReducerFlags) {
    this.serverMethodResponseFlags = flags;
  }
...
export class RemoteTables {
  ...
  get tmServerMethodResponse(): TmServerMethodResponseTableHandle<'tm_server_method_response'> {
    // clientCache is a private property
    return new TmServerMethodResponseTableHandle((this.connection as unknown as { clientCache: __ClientCache }).clientCache.getOrCreateTable<TmServerMethodResponse>(REMOTE_MODULE.tables.tm_server_method_response));
  }
