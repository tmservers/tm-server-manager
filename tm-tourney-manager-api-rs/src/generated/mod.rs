...
// This was generated using spacetimedb cli version 2.0.0-rc1 (commit 42538cf14f7184aaf7d84cab76149d92519eaacb).
...
pub use raw_server_player_remove_reducer::raw_server_player_remove;
    ...
    fn parse_initial_rows(raw: __ws::v2::QueryRows) -> __sdk::Result<Self> {
        ...
        for table_rows in raw.tables {
            match &table_rows.table[..] {
                "available_server_pool" => db_update
                    .available_server_pool
                ...
                "raw_server_pool" => db_update
                    .raw_server_pool
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "raw_server_pool_unverified" => db_update
                    .raw_server_pool_unverified
                    .append(__sdk::parse_row_list_as_inserts(table_rows.rows)?),
                "registered_player" => db_update
                    .registered_player
