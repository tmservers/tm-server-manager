...
spacetime call tm-tourney-manager create_project "My Tournament" "This is a beautiful tournament" "{""__timestamp_micros_since_unix_epoch__"": 1767132984000000 }" "{""__timestamp_micros_since_unix_epoch__"": 1767233084000000 }"
