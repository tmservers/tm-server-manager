...
spacetime call tm-server-manager create_project "My project" "This is a beautiful project" "{""__timestamp_micros_since_unix_epoch__"": 1767132984000000 }" "{""__timestamp_micros_since_unix_epoch__"": 1767233084000000 }"
...
spacetime call tm-server-manager connection_create "{""MatchV1"": 1 }" "{""MatchV1"": 2 }" "{""Waiting"": {}}"