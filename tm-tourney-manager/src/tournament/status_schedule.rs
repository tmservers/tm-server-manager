use spacetimedb::{
  table, ReducerContext, ScheduleAt, Table,
};
...
fn on_tournament_status_schedule_triggered(ctx: &ReducerContext, arg: TournamentStatusScheduleV1) -> Result<(), String> {
...
pub fn schedule_tournament_status_change(
	...
	ctx.db.tab_tournament_status_schedule().try_insert(schedule)?;
